...
// Протокол фигуры Core Animation
protocol ShapeLayerProtocol: CAShapeLayer {
    init(size: CGSize, fillColor: CGColor)
}

// Расширение - запрет пустого конструктора
...
// Универсальный класс - рисует фигуру на основе кривых Безье
